...
<p style="font-size: 20"><strong>Email: </strong> {{ $enquiry->email }}</p>
<p style="font-size: 20"><strong>Phone: </strong> {{ $enquiry->phone }}</p>
<p style="font-size: 20"><strong>Subject: </strong> {{ $enquiry->subject }}</p>
<p style="font-size: 20"><strong>Enquiry:</strong> </p>
<p style="font-size: 20">{{ $enquiry->message }}</p>
